    ...
    <main className="min-h-screen bg-background text-white flex-1">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-12 space-y-8">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-white">Turnaround time</h2>
          <p className="text-white/75 leading-relaxed">
            ...
            <Link href="/account" className="text-neutral-300 underline">Account page</Link>.
          </p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-white">Where we ship</h2>
          <p className="text-white/75 leading-relaxed">
            We currently deliver island-wide within <strong className="text-white">Sri Lanka only</strong>. ORBYT is an online-only business — there is no physical walk-in location.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-white">File issues</h2>
          <p className="text-white/75 leading-relaxed">
            If your file does not meet our{" "}
            <Link href="/file-requirements" className="text-neutral-300 underline">print requirements</Link>,
            we will pause your order and contact you with clear instructions before printing anything. No surprises.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-white">Damaged or misprinted orders</h2>
          <p className="text-white/75 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-white">Returns & cancellations</h2>
          <p className="text-white/75 leading-relaxed">
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-5 text-center space-y-2">
          ...
          <Link href="/contacts" className="inline-flex px-5 py-2 rounded-xl bg-white hover:bg-neutral-800 font-semibold text-sm transition-colors">
            Contact us
          </Link>
        </div>
