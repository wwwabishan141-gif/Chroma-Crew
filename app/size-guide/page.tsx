    ...
    <main className="min-h-screen bg-background text-white flex-1">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-12 space-y-10">
        ...
        <section className="space-y-4" id="sizes">
          <h2 className="text-2xl font-semibold text-white">Print sizes</h2>
          <ul className="list-disc pl-5 text-white/75 space-y-2">
            ...
            <li>
              ...
              <Link href="/wholesale" className="text-neutral-300 underline">
                see bulk pricing
              </Link>
              ).
            </li>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-white">Product Fit</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-white">How to measure garments</h2>
        ...
        <section className="space-y-4" id="press">
          <h2 className="text-2xl font-semibold text-white">Application tips</h2>
        ...
        <p className="text-white/50 text-sm">
          Questions? Read the{" "}
          <Link href="/faq" className="text-neutral-300 underline">
            FAQ
          </Link>{" "}
