  ...
  return (
    <main className="min-h-screen bg-background text-white flex-1">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-12 space-y-6 text-white/75 leading-relaxed">
        ...
        <p>
          These terms apply to your use of the ORBYT website and the purchase of our products. By accessing our site, you agree to these terms.
        </p>
        ...
        <p>
          To the maximum extent permitted by law, ORBYT is not liable for indirect damages arising from the use of our website or products.
        </p>
      </div>
    </main>
  )
