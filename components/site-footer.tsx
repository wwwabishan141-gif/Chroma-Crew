      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-2 pt-1">
              <a
                ...
                className="flex items-center gap-2 text-white/70 hover:text-green-400 text-sm transition-colors"
              >
        ...
        <div className="mt-12 pt-10 border-t border-white/10 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="max-w-md w-full">
            ...
            <p className="text-white/70 text-sm mb-4">Get the latest design drops and exclusive offers delivered to your inbox.</p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-10 pt-8 border-t border-white/10">
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-4 gap-y-1 text-white/60 text-xs">
